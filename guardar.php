...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $ccontraseña = isset($_POST['ccontraseña']) ? trim($_POST['ccontraseña']) : '';

    // Validar que los campos no estén vacíos
    if (empty($nombre) || empty($email) || empty($contraseña) || empty($ccontraseña)) {
    ...
    $datos = "Nombre: $nombre, Correo: $email, Contraseña: $contraseña\n";
